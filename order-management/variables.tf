...
variable "order_management_lambda_name" {
  description = "Name of the order management Lambda function"
  type        = string
}


variable "order_management_lambda_description" {
  description = "value of the handler in the code"
  type        = string
}

variable "order_management_lambda_role_name" {
  description = "Path to the source code zip file for Lambda Function"
  type        = string
}


variable "order_management_tags" {
  description = "Tags for the resources"
  type        = map(string)
}
